...
void addMedicine() {
    ...
    med.price = getIntInput("Price (in cents): ", 0) / 100.0;
    ...
    do {
        ...
        switch (choice) {
            ...
            case 4: {
                ...
                cout << "Cash: " << cashCount << " transactions ($" << cashTotal << ")\n";
                cout << "GCash: " << gcashCount << " transactions ($" << gcashTotal << ")\n";
                cout << "PayMaya: " << paymayaCount << " transactions ($" << paymayaTotal << ")\n";
